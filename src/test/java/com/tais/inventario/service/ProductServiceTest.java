...
class ProductServiceTest {
  ...
  void create() {
    ProductRequest request =
        new ProductRequest(
            "Notebook", "Notebook Gamer", new BigDecimal("20.00"), new BigDecimal("10"), 2L, 3L);
  ...
  void create_whenCategoryNotFound() {
    ProductRequest request =
        new ProductRequest(
            "Arroz", "Pacote 5kg", new BigDecimal("20.00"), new BigDecimal("10"), 99L, 3L);

    when(categoryService.findById(99L))
        .thenThrow(new InventoryNotFoundException("Category not found"));

    InventoryNotFoundException ex =
        assertThrows(InventoryNotFoundException.class, () -> service.create(request));
  ...
  void getAll() {
    ...
    ProductDTO dto = new ProductDTO(4L, "Notebook", null, null, null, null, null);
